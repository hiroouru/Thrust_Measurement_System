...
void setup() {
  Serial.begin(115200);
  Serial.println("Starting ESP32 Relay Node 2");
  ...
  BLEDevice::init("ESP32_Relay_Node_2");
  ...
  pBLEScan->start(60);  // Increased scan time to 60 seconds
  Serial.println("BLE Scan started for 60 seconds");
}
